...
class UserComorbidityResource extends Resource
{
    protected static ?string $model = UserComorbidity::class;
...
//                    ->toggleable(isToggledHiddenByDefault: true),
    ...
    {
        return [
            'index' => Pages\ListUserComorbidities::route('/'),
            'create' => Pages\CreateUserComorbidity::route('/create'),
            'edit' => Pages\EditUserComorbidity::route('/{record}/edit'),
        ];
    }
}
